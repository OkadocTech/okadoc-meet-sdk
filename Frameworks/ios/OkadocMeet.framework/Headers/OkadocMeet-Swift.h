...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OkadocMeet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP10OkadocMeet17JMCallKitListener_")
...
SWIFT_CLASS("_TtC10OkadocMeet14JMCallKitProxy")
