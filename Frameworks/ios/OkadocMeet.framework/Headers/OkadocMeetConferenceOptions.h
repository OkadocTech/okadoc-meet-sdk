...
#import "OkadocMeetUserInfo.h"


@interface OkadocMeetConferenceOptionsBuilder : NSObject
 ...
 */
@property (nonatomic, nullable) OkadocMeetUserInfo *userInfo;
...
@interface OkadocMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(OkadocMeetConferenceOptionsBuilder *_Nonnull))initBlock;
